...
public class EndingCom extends JFrame{
	...
	private File file = new File("marioComFile.txt");
	private List<UserInfo> listInfo = new ArrayList<UserInfo>();
	private int listLength;
	
	public EndingCom(long playTime, int deathCount) {
